...
export const STEPS: Step[] = [
  {
    id: 'step-1',
    number: '01',
    title: 'Activa tu LuckyPass',
    description: 'Elige tu pack y comienza a participar en segundos.',
    icon: 'ClipboardList',
    color: '#7B3FE4',
  ...
  },
  {
    ...
    description: 'Cada participación te acerca a ganar y genera impacto real.',
    icon: 'Gift',
    color: '#FF4DA6',
