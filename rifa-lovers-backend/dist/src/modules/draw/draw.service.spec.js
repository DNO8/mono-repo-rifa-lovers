...
describe('DrawService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(draw_service_1.DrawService);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('executeDraw', () => {
        ...
        it('should throw if raffle not found', async () => {
            ...
            await expect(service.executeDraw('invalid-id', 'admin')).rejects.toThrow(common_1.NotFoundException);
        });
        it('should throw if raffle not closed', async () => {
            ...
            await expect(service.executeDraw('raffle-1', 'admin')).rejects.toThrow(common_1.BadRequestException);
        });
    ...
    describe('getDrawResults', () => {
        ...
        it('should throw if raffle not found', async () => {
            mockPrisma.raffle.findUnique.mockResolvedValue(null);
            await expect(service.getDrawResults('invalid')).rejects.toThrow(common_1.NotFoundException);
        });
    ...
    describe('resetDraw', () => {
        ...
        it('should throw if raffle not found', async () => {
            mockPrisma.raffle.findUnique.mockResolvedValue(null);
            await expect(service.resetDraw('invalid', 'op')).rejects.toThrow(common_1.NotFoundException);
        });
        it('should throw if raffle not in drawn status', async () => {
            ...
            await expect(service.resetDraw('raffle-1', 'op')).rejects.toThrow(common_1.BadRequestException);
        });
    });
...
//# sourceMappingURL=draw.service.spec.js.map