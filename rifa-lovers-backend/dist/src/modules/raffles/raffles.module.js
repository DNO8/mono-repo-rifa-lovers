...
exports.RafflesModule = RafflesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [raffles_service_1.RafflesService, raffles_repository_1.RafflesRepository],
        exports: [raffles_service_1.RafflesService, raffles_repository_1.RafflesRepository],
    })
], RafflesModule);
